...
author: "William Handjaja, Nathan Kung, Egor Gazarov, Dmitry Kalachev"
output:
  html_document:
...
*The highest correlations are between Q1.13-Q1.14 (correlation 0.64), and also Q1.16-Q1.17 (correlation 0.63), and Q1.27-Q1.28 (correlation 0.62). These make sense. For example, 13-14 talks about the latest and greatest, 16-17 talks about the boating knowledge/experience of customer, and 27-28 talks about passion
*
*The correlations imply similarity in the topics addressed by the questions. The questions that have high correlations can be grouped together into one factor.
*
*However, since the correlation values are not very high,it is hard to condense the factors, which means that the customer segments are likely to be very fragmented and there are a lot of factors they go through in the purchasing decision.
*
*
*
*
...
*
*The first component addresses the customers' purpose in buying the boats. Customers buy boats to use in trips, whether to relax or for adventure. (Q21, 18, 19, 24)
*
*The second component addresses the cutomers' dedication to the boating topic. This is shown through question related to passion and whether the customers actively try to learn more (Q 28,27,16,17)
*
* Thrd component is about the branding/status of the boat manufacturer, how 
*
*We choose to put 6 factors to reduce the number of questions captured in each components. If we have more time, we would be analyzing the content of the questions too. At our level, we have about 5-6 questions captured in each component
*
*
*
*
...
# Please use numbers, not column names! e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
profile_attributes_used = c(22,28,10,5,3, 12, 48, 49, 50, 51, 52) 
